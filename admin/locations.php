                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <th>Location ID</th>
                        ...
                        <tbody>
                        <?php
$results = mysqli_query($conn, "SELECT * FROM locations");
if( $results->num_rows !== 0 ) {
   while($rowitem = mysqli_fetch_array($results)) {
    $server = $pterodactyl->servers();
    echo "<tr>";
    echo "<td>" . htmlspecialchars($rowitem['location_name']) . "</td>";
    echo "<td>" . htmlspecialchars($rowitem['location_id']) . "</td>";
  }}else{
      echo '<p><b>Seems you have no locations yet!</b></p>';
  }
?>
                        </tbody>
                      </table>
            ...
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Add Location ID</h4>
                    <div class="table-responsive">
                      <table class="table">
                        <thead>
